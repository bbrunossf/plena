...
export default function SchedulePage() {            
  ...
  //função para atualizar no banco de dados e a cor do evento
//   const eventTemplate = (data: any) => {
//     const handleChange = async (args: any) => {
//           console.log("mudar cor:", args.checked);
//     //     try {
//     //         // Atualização via API/Remix Action
//     //         await fetch(`/api/eventos/${data.Id}`, {
//     //             method: 'PUT',
//     //             body: JSON.stringify({ entregue: args.checked })
//     //         });
//     //         // Atualize o estado ou force reload dos eventos
//     //     } catch (error) { /* Trate erros */ }
//      };

//     return (
//       <div className="e-custom-delivered">  
//             <CheckBoxComponent  
//                 checked={data.entregue} 
//                 change={handleChange} 
//                 label="Entregue"
//             />
...
const eventTemplate = (data: any) => {
  const handleChange = (args: { checked: boolean }) => {
    ...
    // Perform any additional actions with updatedData if needed
    console.log("Evento Atualizado:", updatedData);
  };
