// a caixa de seleção agora salva no banco de dados o valor de 'entregue', mas falta corrigir o valor de 'entregue_em', 
//pois quando a caixa é desmarcada, o valor de 'entregue_em' não é atualizado.

// acho que vai ser mais fácil aplicar 2 campos personalizados, um para 'entregue' e outro para 'entregue_em', na caixa modal
// de edição do evento no componente Schedule. (OpenPopup, eu acho que é isso)
...
//     };
    ...
    const handleCheckboxChange = () => {
      const entregueEm = new Date().toISOString(); // Data e hora atuais      
