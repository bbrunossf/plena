...
Caixa de seleção 'hora extra?' - LEMBRAR DE ATUALIZAR A TABELA COM  ---ALTER TABLE Registro
ADD COLUMN hora_extra BOOLEAN DEFAULT 0 NOT NULL; ---
"""
...
class DailyEntriesWindow:
    ...
    def setup_gui(self):
        ...
        self.tree = ttk.Treeview(
            table_frame,
            columns=("ID", "Timestamp", "Projeto", "Tarefa", "Categoria", "Duração (min)", "hora extra"),
            show="headings"
        )
        ...
        self.tree.heading("hora extra", text="hora extra")
        ...
        self.tree.column("hora extra", width=50, anchor=tk.CENTER)
    ...
    def load_daily_entries(self):
        ...
        SELECT r.id_registro, r.timestamp, o.cod_obra || ' - ' || o.nome_obra AS projeto,
               t.nome_tipo AS tarefa, c.nome_categoria AS categoria, r.duracao_minutos, r.hora_extra
        FROM Registro r
