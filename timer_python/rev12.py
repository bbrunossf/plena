"""
Primeira versão com banco de dados postgres.
Todas as variáveis em ? foram substituídas por %s
Todos os nomes das tabelas foram colocados entre aspas, para respeitar o caseSensitive
Alterado o config do banco de dados, já que não usa mais um arquivo físico para conexão
Retirada a função que verifica o horário ou dia da semana pra marcar a caixa de hora extra
"""
